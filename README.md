...
```
sudo pacman -S xorg xorg-server xorg-xinit qtile firefox alacritty thunar dmenu
```
Then start qtile and copy the rest.

# Rest of pakages:
```
sudo pacman -S thunar nitrogen python dmenu picom brightnessctl git alsa-utils python-psutil acpi dunst exa unzip volumeicon cbatticon network-manager-applet udiskie ntfs-3g glib2 gvfs geeqie libreoffice xf86-video-intel xcb-util-cursor scrot redshift xdotool evince htop
```
================================
```
