...
# Rest of pakages:
```
sudo pacman -S python picom dunst unzip udiskie ntfs-3g glib2 gvfs scrot redshift xdotool evince htop
```
================================
```
sudo pacman -S git brightnessctl python-psutil acpi alsa-utils volumeicon cbatticon network-manager-applet geeqie xcb-util-cursor xf86-video-intel exa
